...
class DQUtilityMergedStack extends Stack {
  constructor(scope, id, props) {
    ...
    // 10. Cognito Setup with actual web app URL - no more placeholders!
    ...
    const ecsAgentConstruct = new EcsAgentConstruct(this, 'EcsAgentConstruct', {
      ...
      jwtSignatureSecret: JWT_SIGNATURE_SECRET,
      sessionStoreBucket: agentConstruct.agentSessionStoreBucket,
      cognitoJwksUrl,
      webAppNotifyUrl: webAppNotifyUrl, // Now we have the actual URL!
      vpc: sharedVpc,
    });
    ...
    // 22. Configure MCP Lambda with dynamic web app URL
    ...
    mcpLambda.addEnvironment('ATHENA_WORKGROUP', 'dq-agent-workgroup');
