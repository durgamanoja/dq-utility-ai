...
class EcsAgentConstruct extends Construct {
    constructor(scope, id, props) {
        ...
        ecsAgentSessionStoreBucket.grantReadWrite(taskRole);
        ...
        const fargateService = new ecsPatterns.ApplicationLoadBalancedFargateService(this, 'DQAgentService', {
            ...
            taskImageOptions: {
                ...
                environment: {
                    ...
                    SESSION_STORE_BUCKET_NAME: ecsAgentSessionStoreBucket.bucketName,
        ...
        this.ecsAgentSessionStoreBucket = ecsAgentSessionStoreBucket;
        this.ecsAgentSessionBucketName = ecsAgentSessionStoreBucket.bucketName;
    }
}
